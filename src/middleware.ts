...
export const config = {
  matcher: [
    '/((?!api/auth|api/cron|api/health|api/scheduler/status|api/debug/scheduler-trace|api/debug/alpaca-probe|_next/static|_next/image|favicon.ico|manifest.webmanifest|.*\\.(?:png|jpg|jpeg|svg|webp|ico)$).*)',
  ],
};
